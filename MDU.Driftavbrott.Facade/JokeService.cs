...
/// <summary>
/// Detta är ett exempelbibliotek, nuget-paket från MDU.Dotnet.Templates.
/// TODO: Uppdatera detta med en beskrivning av vad biblioteket gör
/// </summary>
public class JokeService()
{
    private ILogger _logger = LoggerFactory.Create(builder => builder.AddNLog()).CreateLogger<JokeService>();
    public string GetJoke()
    {
        Trace.Current = Trace.Create();
        _logger.Info("GetJoke anropades.");
